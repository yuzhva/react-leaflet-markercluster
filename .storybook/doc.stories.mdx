...
If you would like to pass some props to the Cluster, please check [List of all Leaflet Marker options](http://leafletjs.com/reference-1.3.0.html#marker-option)
...
If you would like to pass some props to the Cluster, please check [List of all Leaflet Popup options](http://leafletjs.com/reference-1.0.3.html#popup-option)
...
If you would like to pass some props to the Cluster, please check [List of all Leaflet Tooltip options](http://leafletjs.com/reference-1.0.3.html#tooltip-option)
