...
<Map className="markercluster-map" center={[51.0, 19.0]} zoom={4} maxZoom={18}>
  ...
  <MarkerClusterGroup markers={markers} />
    ...
    <div className="alert alert-warning" role="alert">
      <a
        href="https://github.com/YUzhva/react-leaflet-markercluster/blob/master/demo-app/deprecated/examples/marker-options/example-one.js"
...
<Map className="markercluster-map" center={[51.0, 19.0]} zoom={4} maxZoom={18}>
  ...
  <MarkerClusterGroup markers={markers} markerOptions={{ icon: redMarker, title: 'Default title' }} />
    ...
    <div className="alert alert-warning" role="alert">
      <a
        href="https://github.com/YUzhva/react-leaflet-markercluster/blob/master/demo-app/deprecated/examples/marker-options/example-two.js"
        className="alert-link"
        target="_blank"
        rel="noopener noreferrer"
      >
