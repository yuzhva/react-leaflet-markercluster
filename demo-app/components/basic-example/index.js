  ...
  <Map className="markercluster-map" center={[51.0, 19.0]} zoom={4} maxZoom={18}>
    ...
    <MarkerClusterGroup wrapperOptions={{enableDefaultStyle: true}}>
      ...
      <div className="alert alert-danger" role="alert">
        ...
        Also, if you would like to use react-leaflet Marker and send them as children (instead of markers=&#123;&#125; prop), <br />
        then markerOptions API would not work, so you need to use
        &nbsp;<a href="https://github.com/PaulLeCam/react-leaflet/blob/master/docs/Components.md#marker"
            className="alert-link"
            target="_blank">
      ...
      <div className="alert alert-warning" role="alert">
        <a href="https://github.com/YUzhva/react-leaflet-markercluster/blob/master/demo-app/components/basic-example/example-two.js"
          className="alert-link"
          target="_blank">
