...
const CustomOptions = () => {
  return (
    <div className="custom-options">
      <p>You can set them by passing <strong>wrapperOptions=""</strong>
        &nbsp;property to MarkerClusterGroup component.</p>
  ...
  <Map className="markercluster-map" center={[51.0, 19.0]} zoom={4}>
    ...
    />
      ...
      <div className="alert alert-warning" role="alert">
        <a href="https://github.com/YUzhva/react-leaflet-markercluster/blob/master/demo-app/components/custom-options/example-one.js"
  ...
  <Map className="markercluster-map" center={[51.0, 19.0]} zoom={4}>
    ...
    />
      ...
      <div className="alert alert-warning" role="alert">
        <a href="https://github.com/YUzhva/react-leaflet-markercluster/blob/master/demo-app/components/custom-options/example-two.js"
          className="alert-link"
          target="_blank">
