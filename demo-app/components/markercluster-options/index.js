...
const MarkerclusterOptions = () => {
  return (
    <div className="markercluster-options">
      ...
      <p>To send that options, just pass <strong>options=""</strong> property to MarkerClusterGroup component:</p>
  ...
  <Map className="markercluster-map" center={[51.0, 19.0]} zoom={4}>
    ...
    .marker-cluster-custom {
      ...
      <div className="alert alert-warning" role="alert">
        <a href="https://github.com/Leaflet/Leaflet.markercluster#all-options"
      ...
      <div className="alert alert-warning" role="alert">
        <a href="https://github.com/YUzhva/react-leaflet-markercluster/blob/master/demo-app/components/markercluster-options/example-one.js"
          className="alert-link"
          target="_blank">
